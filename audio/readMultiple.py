...
audio1 = AudioSegment.from_file("crash_cymbal.wav") #your first audio file
audio2 = AudioSegment.from_file("snare.wav") #your second audio file
audio3 = AudioSegment.from_file("bass_drum.wav") #your third audio file
